...
use DOMNodeList;
use DOMXPath;
use Selective\XmlDSig\CryptoVerifierInterface;
...
final class XmlSignatureVerifier
{
     ...
     */
    public function __construct(CryptoVerifierInterface $cryptoVerifier, bool $preserveWhiteSpace = false)
    {
    ...
    public function verifyDocument(DOMDocument $xml): bool
    {
        ...
        foreach ($nodes as $signedInfoNode) {
            ...
            /**
             * DGII Requirement: Use Inclusive C14N without parameters.
             * The base library's re-parsing block is commented out because it introduces
             * whitespace discrepancies that break the signature verification.
             */
            $canonicalData = $signedInfoNode->C14N();
